...
本人{legal_rep}（姓名：{legal_rep}，身份证号：{legal_rep_id_card}），系{company_name}的法定代表人。
...
本授权委托书声明：我，{self.company_info.get('legal_rep', '')}，系{company_name}的法定代表人，现授权{authorized_rep}（姓名：{authorized_rep}，职务：{authorized_rep_title}）为我方的合法代理人，就贵方组织{company_name}参加"汉西污水处理厂三期工程电气设备（低压开关柜、动力配电箱等）采购及伴随服务"项目投标、谈判、签约等事宜，以我方名义全权处理。
...
{company_name}是一家专注于电气设备研发、生产、销售和服务的高新技术企业。公司拥有一支经验丰富、技术过硬的专业团队，具备完善的研发、生产、质量保证和售后服务体系。
