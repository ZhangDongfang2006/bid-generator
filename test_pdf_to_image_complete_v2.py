...
print(f"证书文件：{found_cert.get('cert_file', '')}")
...
with tempfile.TemporaryDirectory() as temp_dir:
    ...
    if result.returncode == 0 and output_path.exists():
        ...
        p.add_paragraph(f"证书文件：{found_cert.get('cert_file', '')}")
        ...
        print("4. ✓ Word 文档可以保存")
        print("5. ✓ Word 文档中包含图片")
        print()
        print("修复方案：")
        print("1. ✓ 使用 Ghostscript 直接调用")
        print("2. ✓ 不再依赖 pdf2image 的 convert_from_path 方法")
